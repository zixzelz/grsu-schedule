...
class LeftSubpageViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        case HeaderSection: cell = schrduleCell(indexPath.row)
    ...
    func schrduleCell(row: Int) -> UITableViewCell {
        ...
        var cell: UITableViewCell?
        switch (row) {
        case 0: cell = tableView.dequeueReusableCellWithIdentifier("StudentCellIdentifier")
        case 1: cell = tableView.dequeueReusableCellWithIdentifier("TeacherCellIdentifier")
        case 2: cell = tableView.dequeueReusableCellWithIdentifier("MapCellIdentifier")
